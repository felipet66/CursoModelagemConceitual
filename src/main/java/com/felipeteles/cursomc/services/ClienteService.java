...
import com.felipeteles.cursomc.dto.ClienteDTO;
import com.felipeteles.cursomc.dto.ClienteNewDTO;
...
import com.felipeteles.cursomc.services.exception.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir um cliente vinculado à pedidos!");
		}
	}
