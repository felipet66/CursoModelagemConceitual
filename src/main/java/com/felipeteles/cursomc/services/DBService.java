...
import com.felipeteles.cursomc.domain.ItemPedido;
import com.felipeteles.cursomc.domain.Pagamento;
import com.felipeteles.cursomc.domain.PagamentoComBoleto;
import com.felipeteles.cursomc.domain.PagamentoComCartao;
import com.felipeteles.cursomc.domain.Pedido;
import com.felipeteles.cursomc.domain.Produto;
import com.felipeteles.cursomc.domain.enums.EstadoPagamento;
import com.felipeteles.cursomc.domain.enums.Perfil;
...
import com.felipeteles.cursomc.repositories.ItemPedidoRepository;
import com.felipeteles.cursomc.repositories.PagamentoRepository;
import com.felipeteles.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Escola");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fliptm95@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("23758290", "978458493"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "bdavinis@gmail.com", "27139756031", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("9398921", "213458493"));
		...
		Endereco e3 = new Endereco(null, "Rua Eduardo Avezos", "132", "Sala 2", "Centro", "3213211", cli2, c2);
